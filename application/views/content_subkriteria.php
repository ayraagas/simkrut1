             ...
             <?php foreach ($subkriteria as $skr) { ?>
              <tr>
                ...
                <td>
                 ...
                 <a href="<?php echo 'datasubkriteria/delete'."?id={$skr->id}"; ?>" class="btn btn-danger btn-delete fa fa-minus-circle"> Hapus</a></td>
               </tr>
             </form>
             <?php } ?>
           </div>
        ...
        <form class="form-horizontal" method="POST" action="<?php echo 'datasubkriteria/tambah' ?>">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="number" min="0.1" max="0.5" step="0.1" class="form-control" name="bobot">
              </div>
            </div>
            <div class="form-group">
