 ...
 <ul class="sidebar-menu">
    ...
    <ul class="treeview-menu">
      <li><a href="dataasprak"><i class="fa fa-circle-o"></i>Data Calon Asisten Praktikum
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="dataasprak/grafikrangking"><i class="fa fa-circle-o"></i>Grafik Hasil Rekomendasi</a></li>
  ...
  <li class="treeview">
    ...
    <ul class="treeview-menu">
      <li><a href="datamhs"><i class="fa fa-circle-o"></i>Aktivasi Akun Mahasiswa</a></li>
